# ! [doc = "Peripheral access API for SOC microcontrollers (generated using svd2rust v0.31.2 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
# [repr (C)]
pub struct RegisterBlock { reset : RESET , scratch : SCRATCH , bus_errors : BUS_ERRORS , } impl RegisterBlock { # [doc = "0x00 - "]
# [inline (always)]
...
pub type SOC_RST_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; # [doc = "Field `cpu_rst` reader - Write `1` to this register to reset the CPU(s) of the SoC (Hold Reset)"]
...
pub type CPU_RST_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0 - Write `1` to this register to reset the full SoC (Pulse Reset)"]
# [inline (always)]
...
# [inline (always)]
# [must_use]
pub fn soc_rst (& mut self) -> SOC_RST_W < RESET_SPEC > { SOC_RST_W :: new (self , 0) } # [doc = "Bit 1 - Write `1` to this register to reset the CPU(s) of the SoC (Hold Reset)"]
# [inline (always)]
# [must_use]
pub fn cpu_rst (& mut self) -> CPU_RST_W < RESET_SPEC > { CPU_RST_W :: new (self , 1) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
...
pub type SCRATCH_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 32 , u32 > ; impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn scratch (& self) -> SCRATCH_R { SCRATCH_R :: new (self . bits) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
# [must_use]
pub fn scratch (& mut self) -> SCRATCH_W < SCRATCH_SPEC > { SCRATCH_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type BUS_ERRORS_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 32 , u32 > ; impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn bus_errors (& self) -> BUS_ERRORS_R { BUS_ERRORS_R :: new (self . bits) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
# [must_use]
pub fn bus_errors (& mut self) -> BUS_ERRORS_W < BUS_ERRORS_SPEC > { BUS_ERRORS_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
# [repr (C)]
pub struct RegisterBlock { identifier_mem : IDENTIFIER_MEM , } impl RegisterBlock { # [doc = "0x00 - 8 x 40-bit memory"]
# [inline (always)]
pub const fn identifier_mem (& self) -> & IDENTIFIER_MEM { & self . identifier_mem } } # [doc = "IDENTIFIER_MEM (rw) register accessor: 8 x 40-bit memory\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`identifier_mem::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`identifier_mem::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@identifier_mem`]
module"]
pub type IDENTIFIER_MEM = crate :: Reg < identifier_mem :: IDENTIFIER_MEM_SPEC > ; # [doc = "8 x 40-bit memory"]
...
# [inline (always)]
pub const fn ptr () -> * const leds :: RegisterBlock { Self :: PTR } # [doc = r" Steal an instance of this peripheral"]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Ensure that the new instance of the peripheral cannot be used in a way"]
...
# [doc = r" peripheral instance existing to ensure memory safety; ensure"]
# [doc = r" no stolen instances are passed to such software."]
pub unsafe fn steal () -> Self { Self { _marker : PhantomData } } } impl Deref for LEDS { type Target = leds :: RegisterBlock ; # [inline (always)]
...
pub type OUT_R = crate :: FieldReader < u16 > ; # [doc = "Field `out` writer - "]
pub type OUT_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 16 , u16 > ; impl R { # [doc = "Bits 0:15"]
# [inline (always)]
pub fn out (& self) -> OUT_R { OUT_R :: new ((self . bits & 0xffff) as u16) } } impl W { # [doc = "Bits 0:15"]
# [inline (always)]
# [must_use]
pub fn out (& mut self) -> OUT_W < OUT_SPEC > { OUT_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
# [inline (always)]
pub unsafe fn bits (& mut self , bits : u32) -> & mut Self { self . bits = bits ; self } } # [doc = "Led Output(s) Control.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`out::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`out::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
...
impl crate :: Resettable for OUT_SPEC { const RESET_VALUE : Self :: Ux = 0 ; } } } # [doc = "ROM_ROM"]
pub struct ROM_ROM { _marker : PhantomData < * const () > } unsafe impl Send for ROM_ROM { } impl ROM_ROM { # [doc = r"Pointer to the register block"]
pub const PTR : * const rom_rom :: RegisterBlock = 0xf000_1800 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const rom_rom :: RegisterBlock { Self :: PTR } # [doc = r" Steal an instance of this peripheral"]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Ensure that the new instance of the peripheral cannot be used in a way"]
...
# [doc = r" peripheral instance existing to ensure memory safety; ensure"]
# [doc = r" no stolen instances are passed to such software."]
pub unsafe fn steal () -> Self { Self { _marker : PhantomData } } } impl Deref for ROM_ROM { type Target = rom_rom :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * Self :: PTR } } } impl core :: fmt :: Debug for ROM_ROM { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("ROM_ROM") . finish () } } # [doc = "ROM_ROM"]
pub mod rom_rom { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { rom_rom : ROM_ROM , } impl RegisterBlock { # [doc = "0x00 - 32 x 32768-bit memory"]
# [inline (always)]
pub const fn rom_rom (& self) -> & ROM_ROM { & self . rom_rom } } # [doc = "ROM_ROM (rw) register accessor: 32 x 32768-bit memory\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rom_rom::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rom_rom::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rom_rom`]
module"]
pub type ROM_ROM = crate :: Reg < rom_rom :: ROM_ROM_SPEC > ; # [doc = "32 x 32768-bit memory"]
pub mod rom_rom { # [doc = "Register `ROM_ROM` reader"]
pub type R = crate :: R < ROM_ROM_SPEC > ; # [doc = "Register `ROM_ROM` writer"]
pub type W = crate :: W < ROM_ROM_SPEC > ; # [doc = "Field `rom_rom` reader - "]
pub type ROM_ROM_R = crate :: FieldReader < u32 > ; # [doc = "Field `rom_rom` writer - "]
pub type ROM_ROM_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 32 , u32 > ; impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn rom_rom (& self) -> ROM_ROM_R { ROM_ROM_R :: new (self . bits) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
# [must_use]
pub fn rom_rom (& mut self) -> ROM_ROM_W < ROM_ROM_SPEC > { ROM_ROM_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
# [inline (always)]
pub unsafe fn bits (& mut self , bits : u32) -> & mut Self { self . bits = bits ; self } } # [doc = "32 x 32768-bit memory\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rom_rom::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rom_rom::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ROM_ROM_SPEC ; impl crate :: RegisterSpec for ROM_ROM_SPEC { type Ux = u32 ; } # [doc = "`read()` method returns [`rom_rom::R`](R) reader structure"]
impl crate :: Readable for ROM_ROM_SPEC { } # [doc = "`write(|w| ..)` method takes [`rom_rom::W`](W) writer structure"]
impl crate :: Writable for ROM_ROM_SPEC { const ZERO_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; const ONE_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; } # [doc = "`reset()` method sets ROM_ROM to value 0"]
impl crate :: Resettable for ROM_ROM_SPEC { const RESET_VALUE : Self :: Ux = 0 ; } } } # [doc = "ROM"]
pub struct ROM { _marker : PhantomData < * const () > } unsafe impl Send for ROM { } impl ROM { # [doc = r"Pointer to the register block"]
pub const PTR : * const rom :: RegisterBlock = 0xf000_2000 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const rom :: RegisterBlock { Self :: PTR } # [doc = r" Steal an instance of this peripheral"]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Ensure that the new instance of the peripheral cannot be used in a way"]
...
# [doc = r" peripheral instance existing to ensure memory safety; ensure"]
# [doc = r" no stolen instances are passed to such software."]
pub unsafe fn steal () -> Self { Self { _marker : PhantomData } } } impl Deref for ROM { type Target = rom :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * Self :: PTR } } } impl core :: fmt :: Debug for ROM { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("ROM") . finish () } } # [doc = "ROM"]
pub mod rom { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { rom_page : ROM_PAGE , } impl RegisterBlock { # [doc = "0x00 - "]
# [inline (always)]
pub const fn rom_page (& self) -> & ROM_PAGE { & self . rom_page } } # [doc = "ROM_PAGE (rw) register accessor: \n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rom_page::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rom_page::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rom_page`]
module"]
pub type ROM_PAGE = crate :: Reg < rom_page :: ROM_PAGE_SPEC > ; # [doc = ""]
pub mod rom_page { # [doc = "Register `ROM_PAGE` reader"]
pub type R = crate :: R < ROM_PAGE_SPEC > ; # [doc = "Register `ROM_PAGE` writer"]
pub type W = crate :: W < ROM_PAGE_SPEC > ; # [doc = "Field `rom_page` reader - "]
pub type ROM_PAGE_R = crate :: FieldReader ; # [doc = "Field `rom_page` writer - "]
pub type ROM_PAGE_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 6 > ; impl R { # [doc = "Bits 0:5"]
# [inline (always)]
pub fn rom_page (& self) -> ROM_PAGE_R { ROM_PAGE_R :: new ((self . bits & 0x3f) as u8) } } impl W { # [doc = "Bits 0:5"]
# [inline (always)]
# [must_use]
pub fn rom_page (& mut self) -> ROM_PAGE_W < ROM_PAGE_SPEC > { ROM_PAGE_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
# [inline (always)]
pub unsafe fn bits (& mut self , bits : u32) -> & mut Self { self . bits = bits ; self } } # [doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`rom_page::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`rom_page::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct ROM_PAGE_SPEC ; impl crate :: RegisterSpec for ROM_PAGE_SPEC { type Ux = u32 ; } # [doc = "`read()` method returns [`rom_page::R`](R) reader structure"]
impl crate :: Readable for ROM_PAGE_SPEC { } # [doc = "`write(|w| ..)` method takes [`rom_page::W`](W) writer structure"]
impl crate :: Writable for ROM_PAGE_SPEC { const ZERO_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; const ONE_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; } # [doc = "`reset()` method sets ROM_PAGE to value 0"]
impl crate :: Resettable for ROM_PAGE_SPEC { const RESET_VALUE : Self :: Ux = 0 ; } } } # [doc = "SRAM_SRAM"]
pub struct SRAM_SRAM { _marker : PhantomData < * const () > } unsafe impl Send for SRAM_SRAM { } impl SRAM_SRAM { # [doc = r"Pointer to the register block"]
pub const PTR : * const sram_sram :: RegisterBlock = 0xf000_2800 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const sram_sram :: RegisterBlock { Self :: PTR } # [doc = r" Steal an instance of this peripheral"]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Ensure that the new instance of the peripheral cannot be used in a way"]
...
# [doc = r" peripheral instance existing to ensure memory safety; ensure"]
# [doc = r" no stolen instances are passed to such software."]
pub unsafe fn steal () -> Self { Self { _marker : PhantomData } } } impl Deref for SRAM_SRAM { type Target = sram_sram :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * Self :: PTR } } } impl core :: fmt :: Debug for SRAM_SRAM { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SRAM_SRAM") . finish () } } # [doc = "SRAM_SRAM"]
pub mod sram_sram { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { sram_sram : SRAM_SRAM , } impl RegisterBlock { # [doc = "0x00 - 32 x 2048-bit memory"]
# [inline (always)]
pub const fn sram_sram (& self) -> & SRAM_SRAM { & self . sram_sram } } # [doc = "SRAM_SRAM (rw) register accessor: 32 x 2048-bit memory\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sram_sram::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sram_sram::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sram_sram`]
module"]
pub type SRAM_SRAM = crate :: Reg < sram_sram :: SRAM_SRAM_SPEC > ; # [doc = "32 x 2048-bit memory"]
pub mod sram_sram { # [doc = "Register `SRAM_SRAM` reader"]
pub type R = crate :: R < SRAM_SRAM_SPEC > ; # [doc = "Register `SRAM_SRAM` writer"]
pub type W = crate :: W < SRAM_SRAM_SPEC > ; # [doc = "Field `sram_sram` reader - "]
pub type SRAM_SRAM_R = crate :: FieldReader < u32 > ; # [doc = "Field `sram_sram` writer - "]
pub type SRAM_SRAM_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 32 , u32 > ; impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn sram_sram (& self) -> SRAM_SRAM_R { SRAM_SRAM_R :: new (self . bits) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
# [must_use]
pub fn sram_sram (& mut self) -> SRAM_SRAM_W < SRAM_SRAM_SPEC > { SRAM_SRAM_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
# [inline (always)]
pub unsafe fn bits (& mut self , bits : u32) -> & mut Self { self . bits = bits ; self } } # [doc = "32 x 2048-bit memory\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sram_sram::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sram_sram::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SRAM_SRAM_SPEC ; impl crate :: RegisterSpec for SRAM_SRAM_SPEC { type Ux = u32 ; } # [doc = "`read()` method returns [`sram_sram::R`](R) reader structure"]
impl crate :: Readable for SRAM_SRAM_SPEC { } # [doc = "`write(|w| ..)` method takes [`sram_sram::W`](W) writer structure"]
impl crate :: Writable for SRAM_SRAM_SPEC { const ZERO_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; const ONE_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; } # [doc = "`reset()` method sets SRAM_SRAM to value 0"]
impl crate :: Resettable for SRAM_SRAM_SPEC { const RESET_VALUE : Self :: Ux = 0 ; } } } # [doc = "SRAM"]
pub struct SRAM { _marker : PhantomData < * const () > } unsafe impl Send for SRAM { } impl SRAM { # [doc = r"Pointer to the register block"]
pub const PTR : * const sram :: RegisterBlock = 0xf000_3000 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
pub const fn ptr () -> * const sram :: RegisterBlock { Self :: PTR } # [doc = r" Steal an instance of this peripheral"]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Ensure that the new instance of the peripheral cannot be used in a way"]
...
# [doc = r" peripheral instance existing to ensure memory safety; ensure"]
# [doc = r" no stolen instances are passed to such software."]
pub unsafe fn steal () -> Self { Self { _marker : PhantomData } } } impl Deref for SRAM { type Target = sram :: RegisterBlock ; # [inline (always)]
fn deref (& self) -> & Self :: Target { unsafe { & * Self :: PTR } } } impl core :: fmt :: Debug for SRAM { fn fmt (& self , f : & mut core :: fmt :: Formatter) -> core :: fmt :: Result { f . debug_struct ("SRAM") . finish () } } # [doc = "SRAM"]
pub mod sram { # [doc = r"Register block"]
# [repr (C)]
pub struct RegisterBlock { sram_page : SRAM_PAGE , } impl RegisterBlock { # [doc = "0x00 - "]
# [inline (always)]
pub const fn sram_page (& self) -> & SRAM_PAGE { & self . sram_page } } # [doc = "SRAM_PAGE (rw) register accessor: \n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sram_page::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sram_page::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@sram_page`]
module"]
pub type SRAM_PAGE = crate :: Reg < sram_page :: SRAM_PAGE_SPEC > ; # [doc = ""]
pub mod sram_page { # [doc = "Register `SRAM_PAGE` reader"]
pub type R = crate :: R < SRAM_PAGE_SPEC > ; # [doc = "Register `SRAM_PAGE` writer"]
pub type W = crate :: W < SRAM_PAGE_SPEC > ; # [doc = "Field `sram_page` reader - "]
pub type SRAM_PAGE_R = crate :: FieldReader ; # [doc = "Field `sram_page` writer - "]
pub type SRAM_PAGE_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 2 > ; impl R { # [doc = "Bits 0:1"]
# [inline (always)]
pub fn sram_page (& self) -> SRAM_PAGE_R { SRAM_PAGE_R :: new ((self . bits & 3) as u8) } } impl W { # [doc = "Bits 0:1"]
# [inline (always)]
# [must_use]
pub fn sram_page (& mut self) -> SRAM_PAGE_W < SRAM_PAGE_SPEC > { SRAM_PAGE_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
# [inline (always)]
pub unsafe fn bits (& mut self , bits : u32) -> & mut Self { self . bits = bits ; self } } # [doc = "\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`sram_page::R`](R).  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`sram_page::W`](W). You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SRAM_PAGE_SPEC ; impl crate :: RegisterSpec for SRAM_PAGE_SPEC { type Ux = u32 ; } # [doc = "`read()` method returns [`sram_page::R`](R) reader structure"]
impl crate :: Readable for SRAM_PAGE_SPEC { } # [doc = "`write(|w| ..)` method takes [`sram_page::W`](W) writer structure"]
impl crate :: Writable for SRAM_PAGE_SPEC { const ZERO_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; const ONE_TO_MODIFY_FIELDS_BITMAP : Self :: Ux = 0 ; } # [doc = "`reset()` method sets SRAM_PAGE to value 0"]
impl crate :: Resettable for SRAM_PAGE_SPEC { const RESET_VALUE : Self :: Ux = 0 ; } } } # [doc = "TIMER0"]
pub struct TIMER0 { _marker : PhantomData < * const () > } unsafe impl Send for TIMER0 { } impl TIMER0 { # [doc = r"Pointer to the register block"]
pub const PTR : * const timer0 :: RegisterBlock = 0xf000_3800 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
...
# [repr (C)]
pub struct RegisterBlock { load : LOAD , reload : RELOAD , en : EN , update_value : UPDATE_VALUE , value : VALUE , ev_status : EV_STATUS , ev_pending : EV_PENDING , ev_enable : EV_ENABLE , } impl RegisterBlock { # [doc = "0x00 - Load value when Timer is (re-)enabled. In One-Shot mode, the value written to this register specifies the Timer's duration in clock cycles."]
# [inline (always)]
...
# [inline (always)]
pub const fn update_value (& self) -> & UPDATE_VALUE { & self . update_value } # [doc = "0x10 - Latched countdown value. This value is updated by writing to ``update_value``."]
# [inline (always)]
...
# [inline (always)]
pub const fn ev_status (& self) -> & EV_STATUS { & self . ev_status } # [doc = "0x18 - When a zero event occurs, the corresponding bit will be set in this register. To clear the Event, set the corresponding bit in this register."]
# [inline (always)]
pub const fn ev_pending (& self) -> & EV_PENDING { & self . ev_pending } # [doc = "0x1c - This register enables the corresponding zero events. Write a ``0`` to this register to disable individual events."]
# [inline (always)]
pub const fn ev_enable (& self) -> & EV_ENABLE { & self . ev_enable } } # [doc = "LOAD (rw) register accessor: Load value when Timer is (re-)enabled. In One-Shot mode, the value written to this register specifies the Timer's duration in clock cycles.\n\nYou can [`read`](crate::generic::Reg::read) this register and get [`load::R`].  You can [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`write_with_zero`](crate::generic::Reg::write_with_zero) this register using [`load::W`]. You can also [`modify`](crate::generic::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@load`]
module"]
...
pub type LOAD_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 32 , u32 > ; impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn load (& self) -> LOAD_R { LOAD_R :: new (self . bits) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
# [must_use]
pub fn load (& mut self) -> LOAD_W < LOAD_SPEC > { LOAD_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type RELOAD_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 32 , u32 > ; impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn reload (& self) -> RELOAD_R { RELOAD_R :: new (self . bits) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
# [must_use]
pub fn reload (& mut self) -> RELOAD_W < RELOAD_SPEC > { RELOAD_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type EN_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn en (& self) -> EN_R { EN_R :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
# [must_use]
pub fn en (& mut self) -> EN_W < EN_SPEC > { EN_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type UPDATE_VALUE_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn update_value (& self) -> UPDATE_VALUE_R { UPDATE_VALUE_R :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
# [must_use]
pub fn update_value (& mut self) -> UPDATE_VALUE_W < UPDATE_VALUE_SPEC > { UPDATE_VALUE_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type VALUE_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 32 , u32 > ; impl R { # [doc = "Bits 0:31"]
# [inline (always)]
pub fn value (& self) -> VALUE_R { VALUE_R :: new (self . bits) } } impl W { # [doc = "Bits 0:31"]
# [inline (always)]
# [must_use]
pub fn value (& mut self) -> VALUE_W < VALUE_SPEC > { VALUE_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type ZERO_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0 - Level of the ``zero`` event"]
# [inline (always)]
pub fn zero (& self) -> ZERO_R { ZERO_R :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0 - Level of the ``zero`` event"]
# [inline (always)]
# [must_use]
pub fn zero (& mut self) -> ZERO_W < EV_STATUS_SPEC > { ZERO_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type ZERO_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0 - `1` if a `zero` event occurred. This Event is triggered on a **falling** edge."]
# [inline (always)]
...
# [inline (always)]
# [must_use]
pub fn zero (& mut self) -> ZERO_W < EV_PENDING_SPEC > { ZERO_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type ZERO_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0 - Write a ``1`` to enable the ``zero`` Event"]
# [inline (always)]
pub fn zero (& self) -> ZERO_R { ZERO_R :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0 - Write a ``1`` to enable the ``zero`` Event"]
# [inline (always)]
# [must_use]
pub fn zero (& mut self) -> ZERO_W < EV_ENABLE_SPEC > { ZERO_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub const PTR : * const uart :: RegisterBlock = 0xf000_4000 as * const _ ; # [doc = r"Return the pointer to the register block"]
# [inline (always)]
...
# [repr (C)]
pub struct RegisterBlock { rxtx : RXTX , txfull : TXFULL , rxempty : RXEMPTY , ev_status : EV_STATUS , ev_pending : EV_PENDING , ev_enable : EV_ENABLE , txempty : TXEMPTY , rxfull : RXFULL , } impl RegisterBlock { # [doc = "0x00 - "]
# [inline (always)]
...
# [inline (always)]
pub const fn ev_status (& self) -> & EV_STATUS { & self . ev_status } # [doc = "0x10 - When a rx event occurs, the corresponding bit will be set in this register. To clear the Event, set the corresponding bit in this register."]
# [inline (always)]
pub const fn ev_pending (& self) -> & EV_PENDING { & self . ev_pending } # [doc = "0x14 - This register enables the corresponding rx events. Write a ``0`` to this register to disable individual events."]
# [inline (always)]
pub const fn ev_enable (& self) -> & EV_ENABLE { & self . ev_enable } # [doc = "0x18 - TX FIFO Empty."]
# [inline (always)]
...
pub type RXTX_W < 'a , REG > = crate :: FieldWriter < 'a , REG , 8 > ; impl R { # [doc = "Bits 0:7"]
# [inline (always)]
pub fn rxtx (& self) -> RXTX_R { RXTX_R :: new ((self . bits & 0xff) as u8) } } impl W { # [doc = "Bits 0:7"]
# [inline (always)]
# [must_use]
pub fn rxtx (& mut self) -> RXTX_W < RXTX_SPEC > { RXTX_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type TXFULL_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn txfull (& self) -> TXFULL_R { TXFULL_R :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
# [must_use]
pub fn txfull (& mut self) -> TXFULL_W < TXFULL_SPEC > { TXFULL_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type RXEMPTY_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn rxempty (& self) -> RXEMPTY_R { RXEMPTY_R :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
# [must_use]
pub fn rxempty (& mut self) -> RXEMPTY_W < RXEMPTY_SPEC > { RXEMPTY_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type TX_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; # [doc = "Field `rx` reader - Level of the ``rx`` event"]
pub type RX_R = crate :: BitReader ; # [doc = "Field `rx` writer - Level of the ``rx`` event"]
pub type RX_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0 - Level of the ``tx`` event"]
# [inline (always)]
...
# [inline (always)]
# [must_use]
pub fn tx (& mut self) -> TX_W < EV_STATUS_SPEC > { TX_W :: new (self , 0) } # [doc = "Bit 1 - Level of the ``rx`` event"]
# [inline (always)]
# [must_use]
pub fn rx (& mut self) -> RX_W < EV_STATUS_SPEC > { RX_W :: new (self , 1) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type TX_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; # [doc = "Field `rx` reader - `1` if a `rx` event occurred. This Event is triggered on a **falling** edge."]
pub type RX_R = crate :: BitReader ; # [doc = "Field `rx` writer - `1` if a `rx` event occurred. This Event is triggered on a **falling** edge."]
pub type RX_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0 - `1` if a `tx` event occurred. This Event is triggered on a **falling** edge."]
# [inline (always)]
...
# [inline (always)]
# [must_use]
pub fn tx (& mut self) -> TX_W < EV_PENDING_SPEC > { TX_W :: new (self , 0) } # [doc = "Bit 1 - `1` if a `rx` event occurred. This Event is triggered on a **falling** edge."]
# [inline (always)]
# [must_use]
pub fn rx (& mut self) -> RX_W < EV_PENDING_SPEC > { RX_W :: new (self , 1) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type TX_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; # [doc = "Field `rx` reader - Write a ``1`` to enable the ``rx`` Event"]
pub type RX_R = crate :: BitReader ; # [doc = "Field `rx` writer - Write a ``1`` to enable the ``rx`` Event"]
pub type RX_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0 - Write a ``1`` to enable the ``tx`` Event"]
# [inline (always)]
...
# [inline (always)]
# [must_use]
pub fn tx (& mut self) -> TX_W < EV_ENABLE_SPEC > { TX_W :: new (self , 0) } # [doc = "Bit 1 - Write a ``1`` to enable the ``rx`` Event"]
# [inline (always)]
# [must_use]
pub fn rx (& mut self) -> RX_W < EV_ENABLE_SPEC > { RX_W :: new (self , 1) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type TXEMPTY_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn txempty (& self) -> TXEMPTY_R { TXEMPTY_R :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
# [must_use]
pub fn txempty (& mut self) -> TXEMPTY_W < TXEMPTY_SPEC > { TXEMPTY_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub type RXFULL_W < 'a , REG > = crate :: BitWriter < 'a , REG > ; impl R { # [doc = "Bit 0"]
# [inline (always)]
pub fn rxfull (& self) -> RXFULL_R { RXFULL_R :: new ((self . bits & 1) != 0) } } impl W { # [doc = "Bit 0"]
# [inline (always)]
# [must_use]
pub fn rxfull (& mut self) -> RXFULL_W < RXFULL_SPEC > { RXFULL_W :: new (self , 0) } # [doc = r" Writes raw bits to the register."]
# [doc = r""]
# [doc = r" # Safety"]
# [doc = r""]
# [doc = r" Passing incorrect value can cause undefined behaviour. See reference manual"]
...
pub LEDS : LEDS , # [doc = "ROM_ROM"]
pub ROM_ROM : ROM_ROM , # [doc = "ROM"]
pub ROM : ROM , # [doc = "SRAM_SRAM"]
pub SRAM_SRAM : SRAM_SRAM , # [doc = "SRAM"]
pub SRAM : SRAM , # [doc = "TIMER0"]
...
# [inline]
pub unsafe fn steal () -> Self { DEVICE_PERIPHERALS = true ; Peripherals { CTRL : CTRL { _marker : PhantomData } , IDENTIFIER_MEM : IDENTIFIER_MEM { _marker : PhantomData } , LEDS : LEDS { _marker : PhantomData } , ROM_ROM : ROM_ROM { _marker : PhantomData } , ROM : ROM { _marker : PhantomData } , SRAM_SRAM : SRAM_SRAM { _marker : PhantomData } , SRAM : SRAM { _marker : PhantomData } , TIMER0 : TIMER0 { _marker : PhantomData } , UART : UART { _marker : PhantomData } , } } }
